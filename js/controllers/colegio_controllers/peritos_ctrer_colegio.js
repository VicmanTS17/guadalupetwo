...
.controller('peritos_ctrer_colegio', function($scope, $window, $http, $q){
  ...
  function desc_type(data){
    for (var i = 0; i < data.length; i++) {
      ...
      if (data[i].tipo_usuario === 'id_5ebe10d0b4db29.48120814') { data[i].desc_tipo_usuario = 'Perito'; }
    }
  }
