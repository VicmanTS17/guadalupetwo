...
<div class="row sangria justify">
  Por medio del presente solicito el trámite de <b>'.$licencia["tramite"].'</b> para la construcción ubicada en <b>'.$data_predio["calle"].', Colonia o Fraccionamiento '.$data_predio["colonia"].', Guadalupe, Zac. </b> propiedad de <b>'.$data_prop["nombre"].'</b>.
</div>
<br>
<br>
<div class="row sangria justify">
